...
<div class="made-l-grid">
  <div class="made-l-grid__row">
    ...
    <div class="made-l-grid__item">
      <img
        src="https://cdn.jsdelivr.net/gh/mastercard/made@main/storybook/stories/assets/images/joey.png"
        width="200"
        alt="Joseph Eccles"
      />
      <p>
        <strong>Joseph Eccles</strong> <br />
        Senior UI Engineer
        <br />
          Connect on Teams
      </p>
    ...
    <div class="made-l-grid__item">
      <img
        src="https://cdn.jsdelivr.net/gh/mastercard/made@main/storybook/stories/assets/images/shuma.png"
        width="200"
        alt="Shuma Matsumoto"
      />
      <p>
        <strong>Shuma Matsumoto</strong> <br />
        UI Engineer <br />
          Connect on Teams
      </p>
    </div>
