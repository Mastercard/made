...
<Meta title="Forms/Select" parameters={{ badges: [BADGE.OBSOLETE] }} />
	...
	<div class="made-c-select__wrapper">
		<select id="default" class="made-c-select">
		  ...
		  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="made-c-select__arrow">
                    <path d="M16.25 6.875L10 13.125L3.75 6.875" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
	</div>
		...
		<ul class="made-c-overflow-menu__list made-c-overflow-menu__list--select made-c-scrollbar">
			<li class="made-c-overflow-menu__item">
				<div class="made-c-form__element made-u-width-100">
					...
					/>
					<label
						class="made-c-overflow-menu__multiselect-item made-c-checkbox__label made-c-overflow-menu__link made-c-overflow-menu__link--left-align"
