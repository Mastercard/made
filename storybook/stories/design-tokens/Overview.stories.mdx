...
<blockquote>
  ...
  system e.g. color, type, spacing, that are stored in a <mark>tech agnostic</mark> format as a <mark>single source of truth</mark> to scale across any platform, devices, tech stack.
</blockquote>
