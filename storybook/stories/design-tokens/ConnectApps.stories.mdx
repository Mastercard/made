...
2. Capture screen shots of each page and leverage [this template](https://mastercard.sharepoint.com/:p:/s/MastercardConnect/EbUs-44hibVAoDt9nHVX0aMBtIgWB7BnSmRvXSxZSKauhA?e=AZOOiT) to provide before and after screenshots of your application with the theme applied.

    a. Note: We require you to input before and after screenshots of 90% of your application (e.g., if you have 10 routes / pages in your application, then please provide at least 9 before and after screenshots).  
