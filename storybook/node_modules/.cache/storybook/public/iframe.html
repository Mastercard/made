<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Webpack App</title><meta name="viewport" content="width=device-width,initial-scale=1"><base target="_parent"><style>/* While we aren't showing the main block yet, but still preparing, we want everything the user
  ...
  };</script><script type="text/javascript">let pageURL = window.location.href;
  var di = {
    pageName: "MasterCard | Made CSS",
    siteName: "MasterCard | Made",
    siteType: "corporate:regional",
    pageURL: `${pageURL}`,
    ...
    language: "en",
    pageType: "B2C",
  };</script><script src="https://assets.adobedtm.com/acdc00762da2/c654cf07e29f/launch-
c85b57558ed2-development.min.js"></script><script type="text/javascript">function whenAvailable(name, callback) {
    var interval = 10; //ms
